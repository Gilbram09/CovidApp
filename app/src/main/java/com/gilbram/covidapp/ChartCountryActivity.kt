...
import com.gilbram.covidapp.Model.InfoNegara
import com.gilbram.covidapp.Model.Negara
import com.gilbram.covidapp.Network.InfoService
    ...
    private fun getCountry() {
        ...
        api.getInfoService(SimpanDataNegara).enqueue(object : Callback<List<InfoNegara>>{
                ...
                if (response.isSuccessful){
                    ...
                    while (i < getListDataCorona.size){
                        for (s in getListDataCorona){
                            ...
                            val barEntry2= BarEntry(i.toFloat(), s.Confirmed?.toFloat()?: 0f)
                            val barEntry3= BarEntry(i.toFloat(), s.Confirmed?.toFloat()?: 0f)
                            val barEntry4= BarEntry(i.toFloat(), s.Confirmed?.toFloat()?: 0f)
            ...
            override fun onFailure(call: Call<List<InfoNegara>>, t: Throwable) {
                Toast.makeText(this@ChartCountryActivity,"error re-enter this country",
